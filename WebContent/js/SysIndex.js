...
function addTab(subtitle, url, icon) {
    ...
    //$(".layout-button-left").trigger("click");//收回左侧
    //tabClose();
}
//创建一个页面
...
$(function () {
    $(".ui-skin-nav .li-skinitem span").click(function () {
        var theme = $(this).attr("rel");//主题名称
        $.messager.confirm('提示', '切换皮肤将重新加载系统！', function (r) {
            if (r) {
                $.post("../../SysManage/SetThemes", { value: theme }, function (data) { window.location.reload(); }, "json");
            }
        });
    });
});
